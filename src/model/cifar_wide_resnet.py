...
def WideResNet16_8(num_classes):
    return WideResNet(depth=16, width_factor=8, dropout=.0, in_channels=3, labels=num_classes)

def WideResNet28_10(num_classes):
    return WideResNet(depth=28, width_factor=10, dropout=.0, in_channels=3, labels=num_classes)
